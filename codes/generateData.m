function generateData(numberOfFeatures,numberOfRecords,minBeta,maxBeta,minAlpha,...
...
%     dir = [cd '/data'];
    ...
    save([savingDir '/syntheticData'],'Features','Labels','T','numberOfRecords','numberOfPeriods',...
