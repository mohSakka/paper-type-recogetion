...
%% loading the data
%% loading data
load([cd '/../data/CLBP_dataB']);
load([cd '/../data/Gabor_dataB']);
load([cd '/../data/LBP_dataB']);
load([cd '/../data/Haar_dataB']);
%% input parameters
expansionRate = 10;
%% CLBP
expandedDatasetCLBP = [];
...
%% saving
savingDir = [cd '/../data/'];
save([savingDir 'expandedDatasetLBP_B.mat'],'expandedDatasetLBP');
save([savingDir 'expandedDatasetCLBP_B.mat'],'expandedDatasetCLBP');
save([savingDir 'expandedDatasetGabor_B.mat'],'expandedDatasetGabor');
save([savingDir 'expandedDatasetHaar_B.mat'],'expandedDatasetHaar');
%%