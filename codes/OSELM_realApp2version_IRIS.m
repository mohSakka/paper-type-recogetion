...
%
Features{4} = data(:,4);
Labels{4} = data(:,end);%% Feature Selection parameters
currentInd = 1;
numberOfFeatures = 4;
...
for chunk = 1:numberOfChunks
    ...
    Fn = size(chunkFeatures,2);
        ...
        [Learner{f}] = buildOSELMLearner3(initData,Fn,chunkFeatures,chunkLabels,0.25,...
...
save([cd '/../results/OSELM2version_dataSetIRIS']);
